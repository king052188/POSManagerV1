...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='This store all customers information';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customers` VALUES (1,1,'Aquino','King Paulo','Cabalo',NULL,'Gordon Heights','king@cdgpacific.com','09177715380',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `store` (
  ...
  KEY `NAME` (`NAME`),
  KEY `COUNTRY_CODE` (`COUNTRY_CODE`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='This store all information of store and branches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `store` VALUES (1,'15a3850c197a25644d3245be1e2f69bd','http://localhost:9999','CDG Pacific','SBDMZ SBMA',NULL,NULL,NULL,NULL,'250-2622',2,3,NULL,NULL,NULL,NULL),(2,'77507d2d9305c830e433c4afe6a1657e','http://localhost:9999','Cheap Parts Guy','14th St. Total Gas Station SBMA',NULL,NULL,NULL,NULL,'250-2622',2,3,NULL,NULL,NULL,NULL),(3,'d447e82ce847bd15f5673e7c9d53ad93','http://localhost:9999','Cheap Parts Guy','14th St. Total Gas Station SBMA',NULL,NULL,NULL,NULL,'250-2622',2,3,NULL,NULL,NULL,NULL),(4,'62daa1f845d24aee621e8a8fe65d7d00','http://localhost:9999','Cheap Parts Guy','14th St. Total Gas Station SBMA',NULL,NULL,NULL,NULL,'250-2622',2,3,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2017-08-05 12:50:31
